...
int nsCharSetProber::FilterWithoutEnglishLetters(const char* aBuf, unsigned aLen, char** newBuf, unsigned& newLen)
{
  char *newptr;
  char *prevPtr, *curPtr;

  int meetMSB = PR_FALSE;
...
int nsCharSetProber::FilterWithEnglishLetters(const char* aBuf, unsigned aLen, char** newBuf, unsigned& newLen)
{
  //do filtering to reduce load to probers
  char *newptr;
  char *prevPtr, *curPtr;
  int isInTag = PR_FALSE;
