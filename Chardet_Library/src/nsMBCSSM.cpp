...
static unsigned BIG5_cls [ 256 / 8 ] = {
...
static const unsigned Big5CharLenTable[] = {0, 1, 1, 2, 0};
...
static unsigned EUCJP_cls [ 256 / 8 ] = {
...
static const unsigned EUCJPCharLenTable[] = {2, 2, 2, 3, 1, 0};
...
static unsigned EUCKR_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07
...
static const unsigned EUCKRCharLenTable[] = {0, 1, 2, 0};
...
static unsigned EUCTW_cls [ 256 / 8 ] = {
...
static const unsigned EUCTWCharLenTable[] = {0, 0, 1, 2, 2, 2, 3};
...
static unsigned GB2312_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,0,0),  // 08 - 0f
PCK4BITS(1,1,1,1,1,1,1,1),  // 10 - 17
...
static unsigned GB2312_st [ 2] = {
PCK4BITS(eError,eStart,     3,eError,eError,eError,eError,eError),//00-07
PCK4BITS(eItsMe,eItsMe,eItsMe,eItsMe,eError,eError,eStart,eStart) //08-0f
};

static const unsigned GB2312CharLenTable[] = {0, 1, 2, 0};
...
static unsigned GB18030_cls [ 256 / 8 ] = {
PCK4BITS(1,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,0,0),  // 08 - 0f
PCK4BITS(1,1,1,1,1,1,1,1),  // 10 - 17
PCK4BITS(1,1,1,0,1,1,1,1),  // 18 - 1f
...
// 2 here.
static const unsigned GB18030CharLenTable[] = {0, 1, 1, 1, 1, 1, 2};
...
static unsigned SJIS_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,1,1),  // 00 - 07
PCK4BITS(1,1,1,1,1,1,0,0),  // 08 - 0f
PCK4BITS(1,1,1,1,1,1,1,1),  // 10 - 17
...
static unsigned SJIS_st [ 3] = {
PCK4BITS(eError,eStart,eStart,     3,eError,eError,eError,eError),//00-07
PCK4BITS(eError,eError,eError,eError,eItsMe,eItsMe,eItsMe,eItsMe),//08-0f
PCK4BITS(eItsMe,eItsMe,eError,eError,eStart,eStart,eStart,eStart) //10-17
};

static const unsigned SJISCharLenTable[] = {0, 1, 1, 2, 0, 0};
...
static unsigned UCS2BE_cls [ 256 / 8 ] = {
...
static const unsigned UCS2BECharLenTable[] = {2, 2, 2, 0, 2, 2};
...
static unsigned UCS2LE_cls [ 256 / 8 ] = {
PCK4BITS(0,0,0,0,0,0,0,0),  // 00 - 07
PCK4BITS(0,0,1,0,0,2,0,0),  // 08 - 0f
PCK4BITS(0,0,0,0,0,0,0,0),  // 10 - 17
PCK4BITS(0,0,0,3,0,0,0,0),  // 18 - 1f
...
static const unsigned UCS2LECharLenTable[] = {2, 2, 2, 2, 2, 2};
...
static unsigned UTF8_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07
...
static const unsigned UTF8CharLenTable[] = {0, 1, 0, 0, 0, 0, 2, 3,
                            3, 3, 4, 4, 5, 5, 6, 6 };
