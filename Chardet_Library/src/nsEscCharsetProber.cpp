...
nsEscCharSetProber::nsEscCharSetProber(unsigned aLanguageFilter)
{
  for (unsigned i = 0; i < NUM_OF_ESC_CHARSETS; i++)
    mCodingSM[i] = nsnull;
...
nsProbingState nsEscCharSetProber::HandleData(const char* aBuf, unsigned aLen)
{
