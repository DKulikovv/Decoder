...
public:
  ...
  virtual nsProbingState HandleData(const char* aBuf, unsigned aLen) = 0;
  ...
  static int FilterWithoutEnglishLetters(const char* aBuf, unsigned aLen, char** newBuf, unsigned& newLen);
  static int FilterWithEnglishLetters(const char* aBuf, unsigned aLen, char** newBuf, unsigned& newLen);
